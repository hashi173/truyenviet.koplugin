...
function login(token, cookies) {
    return new Promise((resolve, reject) => {
        const body = `login=${encodeURIComponent('phamthithienha17032005@gmail.com')}&password=${encodeURIComponent('Thienh@17032005')}&remember=1&register=0&_xfRedirect=${encodeURIComponent('https://tve-4u.org/')}&_xfToken=${encodeURIComponent(token)}`;
